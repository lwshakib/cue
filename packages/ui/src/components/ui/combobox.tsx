...
function ComboboxChip({
  ...
  return (
    ...
    >
      {children}
      {showRemove && (
        <ComboboxPrimitive.ChipRemove className="-ml-1 opacity-50 hover:opacity-100" data-slot="combobox-chip-remove" render={<Button variant="ghost" className="h-6 w-6 p-0 rounded-sm"><XIcon className="pointer-events-none size-4" /></Button>} />
      )}
    </ComboboxPrimitive.Chip>
  )
}
