    ...
    <div className="relative z-10 w-full max-w-md bg-card/60 backdrop-blur-xl border border-border p-8 md:p-10 shadow-[0_0_50px_rgba(0,0,0,0.5)] group overflow-hidden">
      ...
      <div className="flex flex-col gap-6">
        <div className="text-center">
          <h1 className="text-2xl md:text-3xl font-normal tracking-tight text-foreground font-orbitron">Create Account</h1>
        </div>

        <form onSubmit={handleSubmit} className="flex flex-col gap-5">
          {/* Name Field */}
          <div className="space-y-2">
            <label htmlFor="name" className="text-[11px] font-sans font-medium uppercase tracking-wider text-muted-foreground">Full Name</label>
          ...
          <div className="space-y-2">
            <label htmlFor="confirmPassword" className="text-[11px] font-sans font-medium uppercase tracking-wider text-muted-foreground">Confirm Password</label>
            <div className="relative">
              <ShieldCheck className="absolute left-3 top-1/2 -translate-y-1/2 w-4 h-4 text-primary/50" />
              <input
                id="confirmPassword"
                type="password"
                placeholder="••••••••"
        ...
        <div className="flex flex-col gap-4 mt-2">
          <div className="flex items-center gap-3">
            ...
            <span className="text-[9px] font-sans font-medium uppercase tracking-[0.2em] text-muted-foreground">Or sign up with</span>
            <div className="h-px flex-1 bg-border"></div>
          </div>
